...
Prefix "sync-distro" rsync -ai --delete "$MMDAPP/.local/output-cache/distro/" "$MMDAPP/distro" </dev/null & # parallel
Prefix "sync-export" rsync -ai --delete "$MMDAPP/.local/output-cache/export/" "$MMDAPP/export" </dev/null & # parallel
